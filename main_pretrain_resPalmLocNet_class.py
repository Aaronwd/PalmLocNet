...
parser.add_argument('-m','--MODELFOLDER',type= str, default='./resnet_param/',
...
class myPalmLocNet(nn.Module):
    def __init__(self, model):
        super(myPalmLocNet, self).__init__()
